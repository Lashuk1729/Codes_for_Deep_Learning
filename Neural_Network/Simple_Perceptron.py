...
def perceptron_AND(test_input, weights, bais):
...
def perceptron_OR(test_input, weights, bais):
...
outputs = perceptron_AND(test_inputs, weights, bias)
...
outputs = perceptron_OR(test_inputs, weights, bias)
